...
$user = admin_require_setup_pending();
$error = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        admin_update_user_credentials((int) $user['id'], $username, $password, true);
        admin_flash('success', 'Credentials updated. Welcome to the admin panel.');
